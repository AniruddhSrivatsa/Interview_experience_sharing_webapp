...
const home_page="Welcome to the home page"
const about_page="This web app helps the junior students to prepare well for their interviews by the experiences shared byy the seniors"
...
app.get("/:company", function(req, res){
    var comp=_.lowerCase(req.params.company);
...
app.get("/details/:id",function(req, res){
  ...
  app.post("/mod/:id",function(req, res)
  {
      ...
      exp.findByIdAndUpdate(req.params.id,{ $set:{description: req.body.describe, company: req.body.company,
        post:req.body.post,review:req.body.review,topics:req.body.topics}},function(err){
          if(err)
          {
              console.log(err);
          }
